...
const TOOLS = [
  ...
  },
  {
    id: 'art-history',
    icon: '🎨',
    title: 'Magister Artis',
    subtitle: 'Art History · 1492–1900',
    desc: 'Renaissance to Impressionism — artists, periods, and techniques with an AI tutor who asks as much as he tells.',
    accent: '#9b6a2a',
    href: '/magister-artis',
    status: 'active',
    tag: 'Active',
  },
  {
    id: 'architecturae',
    icon: '🏛',
    title: 'Magister Architecturae',
    subtitle: 'Architectural Drawing · Year One · Forms IA & IIA',
    desc: 'Twelve weeks of looking, measuring, and drawing. Plan, elevation, a vanishing path, then drum and dome — Year One ends with the child’s own west elevation of an Orthodox church. Living books from Project Gutenberg: Vitruvius, van Millingen, Hawkins, Storey, Richardson.',
    accent: '#8a5a28',
    href: '/magister-architecturae',
    status: 'active',
    tag: 'Active',
  },
  { id: 'history',
