...
const LIBRARY = {
  ...
  pitch: {
    ...
    items: [
      ...
      { key: 'ps-52', label: 'Intervals in C major (5.2)', pdf: '/scores/Pitch_Supplement_5.2-1_-_Intervals_in_C_Major.pdf' },
      { key: 'ps-71', label: 'Intervals in F major (7.1)', pdf: '/scores/Pitch_Supplement_7.1_1_-_Intervals_in_F_Major_with_SOL-FA.pdf' },
